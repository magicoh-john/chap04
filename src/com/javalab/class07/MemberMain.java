...
/**
 * [미션1]
 * 1. 다음과 같이 member[] 배열에는 콤머로 구분된 한 회원에 대한 정보가 들어있다.
 * 2. 콤머로 구분된 회원 데이터를 split 함수로 분리해서 각각의 회원 객체를 만드세요.
 * 3. 생성된 회원 객체를 객체 배열에 담아서 출력하시오.
...
public class MemberMain {
	...
	private static void initData(Member[] members) {
		...
		for(int i=0; i<member.length; i++) {
			...
			//arr[0]="봉기", arr[1]="20180419", arr[2]="20181002"
			int numVisit = Integer.parseInt(arr[3]);
			char gender = arr[4].charAt(0);			
			members[i] = new Member(arr[0], arr[1], arr[2], numVisit, gender, arr[5]); //객체생성
		}		
	}

	// 40대 이상 회원들의 숫자 구하는 메소드
	...
	private static void printMemberList(Member[] members) {
		System.out.printf("=================================================================\n");
		System.out.printf("  이름           가입일                   최종방문일          	방문횟수        성별             연령대           \n");
		System.out.printf("=================================================================\n");
		
		for(Member mem1 : members) {
			System.out.printf("%s \t %s \t %s \t %d \t %c \t %s \n", mem1.getName(), mem1.getJoinDate(), mem1.getLastVisitDate(), mem1.getNumVisit(), mem1.getGender(), mem1.getAge());			
		}
		System.out.printf("=================================================================\n");		
		System.out.println();
